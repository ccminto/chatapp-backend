...
import { UserPool, VerificationEmailStyle, UserPoolClient, AccountRecovery } from 'aws-cdk-lib/aws-cognito';
import { GraphqlApi, AuthorizationType, FieldLogLevel, MappingTemplate, Schema, UserPoolDefaultAction } from '@aws-cdk/aws-appsync-alpha';
...
export class ChatappBackendStack extends Stack {
 constructor(scope: Construct, id: string, props?: StackProps) {
  ...
  new cdk.CfnOutput(this, "UserPoolClientId", {
    ...
    const queue = new sqs.Queue(this, 'ChatappBackendQueue', {
      visibilityTimeout: cdk.Duration.seconds(300)
    });

// DynamoDB Tables and Global Secondary Index (GSIs)
